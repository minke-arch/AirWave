...
import { Heart, Film, Award, Sparkles, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function HomePage() {
  ...
  const filteredMovies = dummyMovies.filter((movie) => {
    if (activeTab === "chart") {
      return movie.id !== "spiderman" || movie.bookingRate !== "0%"; // active chart items
    } else {
      return movie.id === "spiderman"; // future release
    }
  });
  ...
  return (
    <Layout>
      <div className="flex flex-col bg-white">
        ...
        <div className="relative group/carousel w-full overflow-hidden select-none">
